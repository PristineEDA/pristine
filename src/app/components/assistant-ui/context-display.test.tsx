...
describe('ContextDisplay', () => {
  ...
  it('renders supplied mock usage as a ring without reading backend token metadata', () => {
    ...
    expect(screen.getByRole('button', { name: 'Context usage' })).toContainElement(container.querySelector('svg'));
    expect(container.querySelector('svg')).toHaveAttribute('width', '24');
    expect(container.querySelector('circle[stroke-linecap="round"]')).toHaveClass('stroke-emerald-500');
  ...
  it('renders supplied mock usage as a bar without reading backend token metadata', () => {
    render(
      <ContextDisplay.Bar
        modelContextWindow={128_000}
        side="bottom"
